...
def proc_raw(stn):
    ctd_raw = Path('/Users/gunnar/Projects/blt/data/blt2/ctd/raw')
    ...
    ctd_proc = Path('/Users/gunnar/Projects/blt/data/blt2/ctd/proc')
    ...
    # to .mat (NOTE: need to fix a bug in ctdproc to get this working again)
