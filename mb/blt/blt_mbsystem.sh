...
# rename
mv $GRD_DIR/grd/foo.grd $GRD_DIR/grd/blt_canyon_50m.nc
mv $PROCESS_DIR/foo_sd.grd $GRD_DIR/grd/blt_canyon_50m_sd.nc
mv $PROCESS_DIR/foo_num.grd $GRD_DIR/grd/blt_canyon_50m_num.nc
