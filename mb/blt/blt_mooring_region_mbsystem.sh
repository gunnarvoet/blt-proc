...
./GV_MBsystem.sh -11.97 -11.82 54.14 54.25 50 all $GRD_DIR

# rename
mv $GRD_DIR/grd/foo.grd $GRD_DIR/grd/blt_canyon_zoom_50m.nc
mv $PROCESS_DIR/foo_sd.grd $GRD_DIR/grd/blt_canyon_zoom_50m_sd.nc
mv $PROCESS_DIR/foo_num.grd $GRD_DIR/grd/blt_canyon_zoom_50m_num.nc
