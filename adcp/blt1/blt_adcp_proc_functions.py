...
def process_adcp(
    ...
    the gadcp package but also conveniently constructs file paths, loads
    default processing parameters, adds metadata to the output, and saves as
    netcdf if desired.
    ...
    # load default parameters and update with parameters provided
